      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col items-center border border-gray-100">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="flex flex-col items-center">
            ...
            <span className="text-[12px] mt-1 text-blue-600 font-bold">範囲選択</span>
          </div>
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold font-serif text-gray-800">写真の範囲を調整</h2>
        ...
        >
          <img
            ...
            onLoad={onImageLoad}
            alt="Crop Source"
            className="max-w-full max-h-[50vh] object-contain block opacity-50"
            draggable={false}
          />
          ...
          >
            ...
            <div className="absolute inset-[3%] border border-dashed border-blue-400/80 pointer-events-none">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[11px] bg-blue-600 text-white px-2 py-1 rounded-full font-bold shadow-sm whitespace-nowrap">
                額縁セーフエリア
              </div>
            </div>
            ...
            <div
              className="absolute -bottom-4 -right-4 w-12 h-12 bg-blue-600 cursor-nwse-resize flex items-center justify-center hover:bg-blue-500 transition-all rounded-full border-4 border-white shadow-lg active:scale-90"
        ...
        <div className="flex flex-col sm:flex-row gap-6 mt-10 w-full max-w-lg">
           <button
            onClick={onCancel}
            className="flex-1 px-6 py-5 bg-gray-100 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-all text-sm active:scale-95"
          >
            やり直す
          </button>
          <button
            onClick={executeCrop}
            className="flex-1 px-6 py-5 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg text-sm flex items-center justify-center gap-3 active:scale-95 hover:shadow-blue-200 hover:shadow-xl"
          >
